...
func (c *userServiceClient) GetUsers(ctx context.Context, in *GetUsersRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[User], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedUserServiceServer) GetUsers(*GetUsersRequest, grpc.ServerStreamingServer[User]) error {
...
func _UserService_GetUsers_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(UserServiceServer).GetUsers(m, &grpc.GenericServerStream[GetUsersRequest, User]{ServerStream: stream})
}
